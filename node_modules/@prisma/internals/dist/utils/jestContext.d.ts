 ...
 */
declare type ContextContributorFactory<Settings, Context, NewContext> = Settings extends {} ? () => ContextContributor<Context, NewContext> : (settings: Settings) => ContextContributor<Context, NewContext>;
/**
 * A function that provides additional test context.
 */
declare type ContextContributor<Context, NewContext> = (ctx: Context) => Context & NewContext;
/**
 * Test context contributor. Mocks console.error with a Jest spy before each test.
 */
declare type ConsoleContext = {
    mocked: {
