declare type LintSchemaParams = {
    schema: string;
};
declare type LintDiagnosticBase = {
    start: number;
    end: number;
    text: string;
};
export declare type LintWarning = {
    is_warning: true;
} & LintDiagnosticBase;
export declare type LintError = {
    is_warning: false;
} & LintDiagnosticBase;
export declare type LintDiagnostic = LintWarning | LintError;
/**
