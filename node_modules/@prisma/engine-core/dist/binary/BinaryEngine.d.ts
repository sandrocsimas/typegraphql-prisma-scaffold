...
export declare class BinaryEngine extends Engine {
    ...
    request<T>({ query, headers, numTry, isWrite, transaction, }: RequestOptions<undefined>): Promise<QueryEngineResult<T>>;
    requestBatch<T>({ queries, headers, transaction, numTry, containsWrite, }: RequestBatchOptions): Promise<BatchQueryEngineResult<T>[]>;
    /**
