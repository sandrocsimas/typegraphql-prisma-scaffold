...
import type { BatchQueryEngineResult, EngineConfig, EngineEventType, RequestBatchOptions, RequestOptions } from '../common/Engine';
import { Engine } from '../common/Engine';
import { Metrics, MetricsOptionsJson, MetricsOptionsPrometheus } from '../common/types/Metrics';
import type { ConfigMetaFormat, QueryEngineLogLevel } from '../common/types/QueryEngine';
...
export declare class LibraryEngine extends Engine {
    ...
    request<T>({ query, headers }: RequestOptions<undefined>): Promise<{
        data: T;
        elapsed: number;
    }>;
